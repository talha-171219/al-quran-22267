      ...
      <div className="max-w-2xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="space-y-4 text-white/80 leading-relaxed">
          <p className="text-lg md:text-xl">
            Designed and Developed by Monirul hasan talha✨ 
          </p>
          <p className="text-base md:text-lg">এখানে আপনি কোরআনের পুরো অনুবাদ, তাজবীদসহ পাঠ, সূরা-অনুসারে সার্চ,বুকমার্ক, প্রিমিয়াম এআই বট, আপনার নামাজের সময়সূচি ও দোয়া ফিচারগুলো এবং কাছাকাছি মসজিদ ফাইন্ডার-সহ অনেক সুবিধা পাবেন।</p>
