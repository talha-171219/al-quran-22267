...
export const changelog: ReleaseNote[] = [
  {
    ...
    date: '২০২৫-১১-১১',
    features: [
      '🕋 সম্পূর্ণ হজ গাইড সেকশন যোগ',
      '📖 ধাপে ধাপে মানাসিক (১০টি ধাপ)',
      '🤲 দোয়া ও তালবিয়াহ (অডিও সহ)',
      '✅ হজের চেকলিস্ট (৫ ক্যাটাগরি)',
      '🗺️ ইন্টারেক্টিভ মানচিত্র',
      '❓ প্রশ্ন ও উত্তর (FAQ)',
      '📅 হজ ক্যালেন্ডার ও কাউন্টডাউন',
      '⭐ প্রতিটি ধাপে ছবি ও বিস্তারিত তথ্য',
      '💾 অফলাইন প্রগ্রেস ট্র্যাকিং',
      '🔖 বুকমার্ক সুবিধা',
    ],
    improvements: [
      'হজের সব তথ্য বাংলায়',
      'সুন্দর UI/UX ডিজাইন',
      'ভিড়ের মাত্রা প্রদর্শন',
      'সময়সূচী ও দূরত্ব তথ্য',
    ],
  },
  {
    version: '3.3',
